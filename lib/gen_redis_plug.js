...
var PING_RATIO = 100; //typical 10msec * 100 = 1sec between redis pings
...
exports.constructor = function($, spec) {
     ...
     *
     * caf.redis type is {port: number, hostname: string, password: string | null}
     *
